...
public class ERC20Allowance : MonoBehaviour
{
    public async void Allowance()
    {
        //chain
        ...
        // spender
        string spender = "0xFE8482cbFcEeE21853E67ca44705d13fc0964F60";
        // amount
        string owner = $"{APIManager.Instance.playerWallet}";
        // function name
        string method = "allowance";
        //Contract
        string contract = "0x0104978B2f8AaE89547b7769BDF90cA53236D409";
        // put arguments in an array of string
        string[] obj = { owner, spender};
        // serialize arguments
        ...
        try
        {
            ...
            if (response == "0")
            {                
                Debug.Log($"Allowance NotValid");
                GameManager.instance.Goto_ApprovePanel();
            }
            else
            {
                Debug.Log($"Allowance IsValid");               

                GameManager.instance.Goto_BuyTokenPanel();
