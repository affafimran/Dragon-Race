...
public class EthBalanceOfExample : MonoBehaviour
{
    ...
    async void balance()
    {
        ...
        string account = $"{APIManager.Instance.playerWallet}";

        string balance = await EVM.BalanceOf(chain, network, account);
        print($"Balance Of: {balance}");       
    }
}
